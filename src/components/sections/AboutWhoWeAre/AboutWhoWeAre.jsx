                ...
                <div className={styles.contentWrapper}>
                    <div className={styles.imageContent} ref={imageRef}>
                        <div className={styles.imageWrapper}>
                            <img src={shopFrontImg} alt="Street view of the Mac Auto Services workshop entrance in Bromley, Christchurch" className={styles.image} width="600" height="400" loading="lazy" decoding="async" />
                        </div>
