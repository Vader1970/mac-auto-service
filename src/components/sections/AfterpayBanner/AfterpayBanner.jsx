...
import styles from './AfterpayBanner.module.css';

const AfterpayBanner = () => {
    return (
        <div className={styles.bannerContainer}>
            <div className={styles.bannerContent}>
                <div className={styles.bannerText}>
                    <strong>Book now.</strong> <span className={styles.regularText}>Pay better.</span>
                </div>
                <div className={styles.svgWrapper}>
                    <svg 
                        version="1.1" 
                        xmlns="http://www.w3.org/2000/svg" 
                        viewBox="35 135 500 110" 
                        className={styles.afterpaySvg}
                        xmlSpace="preserve"
                    >
